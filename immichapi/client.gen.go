...
const (
	...
	AlbumUserBackfillV1        SyncEntityType = "AlbumUserBackfillV1"
	...
	PartnerAssetBackfillV1     SyncEntityType = "PartnerAssetBackfillV1"
	PartnerAssetDeleteV1       SyncEntityType = "PartnerAssetDeleteV1"
	PartnerAssetExifBackfillV1 SyncEntityType = "PartnerAssetExifBackfillV1"
	...
	SyncAckV1                  SyncEntityType = "SyncAckV1"
...
type ActivityResponseDto struct {
	AssetId   nullable.Nullable[string] `json:"assetId"`
...
type AlbumResponseDto struct {
	...
	AlbumThumbnailAssetId      nullable.Nullable[string] `json:"albumThumbnailAssetId"`
...
type AssetBulkUpdateDto struct {
	...
	DuplicateId      nullable.Nullable[string] `json:"duplicateId,omitempty"`
	Ids              []openapi_types.UUID      `json:"ids"`
...
type AssetFaceResponseDto struct {
	...
	ImageHeight   int                                  `json:"imageHeight"`
	ImageWidth    int                                  `json:"imageWidth"`
	Person        nullable.Nullable[PersonResponseDto] `json:"person"`
...
type AssetResponseDto struct {
	...
	LibraryId        nullable.Nullable[string] `json:"libraryId,omitempty"`
	LivePhotoVideoId nullable.Nullable[string] `json:"livePhotoVideoId,omitempty"`
	...
	Stack           nullable.Nullable[AssetStackResponseDto] `json:"stack,omitempty"`
	Tags            *[]TagResponseDto                        `json:"tags,omitempty"`
	Thumbhash       nullable.Nullable[string]                `json:"thumbhash"`
...
type ExifResponseDto struct {
	...
	DateTimeOriginal nullable.Nullable[time.Time] `json:"dateTimeOriginal,omitempty"`
	Description      nullable.Nullable[string]    `json:"description,omitempty"`
	ExifImageHeight  nullable.Nullable[float32]   `json:"exifImageHeight,omitempty"`
	ExifImageWidth   nullable.Nullable[float32]   `json:"exifImageWidth,omitempty"`
	ExposureTime     nullable.Nullable[string]    `json:"exposureTime,omitempty"`
	FNumber          nullable.Nullable[float32]   `json:"fNumber,omitempty"`
	FileSizeInByte   nullable.Nullable[int64]     `json:"fileSizeInByte,omitempty"`
	FocalLength      nullable.Nullable[float32]   `json:"focalLength,omitempty"`
	Iso              nullable.Nullable[float32]   `json:"iso,omitempty"`
	Latitude         nullable.Nullable[float32]   `json:"latitude,omitempty"`
	LensModel        nullable.Nullable[string]    `json:"lensModel,omitempty"`
	...
	ModifyDate       nullable.Nullable[time.Time] `json:"modifyDate,omitempty"`
	Orientation      nullable.Nullable[string]    `json:"orientation,omitempty"`
	ProjectionType   nullable.Nullable[string]    `json:"projectionType,omitempty"`
	Rating           nullable.Nullable[float32]   `json:"rating,omitempty"`
...
type LibraryResponseDto struct {
	...
	Name              string                       `json:"name"`
	OwnerId           string                       `json:"ownerId"`
	RefreshedAt       nullable.Nullable[time.Time] `json:"refreshedAt"`
	UpdatedAt         time.Time                    `json:"updatedAt"`
}
...
type MapMarkerResponseDto struct {
	...
	State   nullable.Nullable[string] `json:"state"`
}
...
type MetadataSearchDto struct {
	...
	LensModel        nullable.Nullable[string]             `json:"lensModel,omitempty"`
	LibraryId        nullable.Nullable[openapi_types.UUID] `json:"libraryId,omitempty"`
...
type NotificationCreateDto struct {
	...
	ReadAt      nullable.Nullable[time.Time] `json:"readAt,omitempty"`
...
type PeopleUpdateItem struct {
	...
	BirthDate nullable.Nullable[openapi_types.Date] `json:"birthDate,omitempty"`
...
type PersonResponseDto struct {
	BirthDate nullable.Nullable[openapi_types.Date] `json:"birthDate"`
...
type ReverseGeocodingStateResponseDto struct {
	LastImportFileName nullable.Nullable[string] `json:"lastImportFileName"`
	LastUpdate         nullable.Nullable[string] `json:"lastUpdate"`
}
...
type SystemConfigOAuthDto struct {
	...
	DefaultStorageQuota     nullable.Nullable[int64]     `json:"defaultStorageQuota"`
	Enabled                 bool                         `json:"enabled"`
...
type UpdateAssetDto struct {
	...
	IsFavorite       *bool                                 `json:"isFavorite,omitempty"`
	Latitude         *float32                              `json:"latitude,omitempty"`
	LivePhotoVideoId nullable.Nullable[openapi_types.UUID] `json:"livePhotoVideoId,omitempty"`
	Longitude        *float32                              `json:"longitude,omitempty"`
	Rating           *float32                              `json:"rating,omitempty"`
	Visibility       *AssetVisibility                      `json:"visibility,omitempty"`
}
...
type UsageByUserDto struct {
	Photos           int                      `json:"photos"`
	QuotaSizeInBytes nullable.Nullable[int64] `json:"quotaSizeInBytes"`
	Usage            int64                    `json:"usage"`
	UsagePhotos      int64                    `json:"usagePhotos"`
	UsageVideos      int64                    `json:"usageVideos"`
	UserId           string                   `json:"userId"`
...
type UserAdminCreateDto struct {
	AvatarColor          nullable.Nullable[UserAvatarColor] `json:"avatarColor,omitempty"`
	Email                openapi_types.Email                `json:"email"`
	IsAdmin              *bool                              `json:"isAdmin,omitempty"`
	Name                 string                             `json:"name"`
	Notify               *bool                              `json:"notify,omitempty"`
	Password             string                             `json:"password"`
	QuotaSizeInBytes     nullable.Nullable[int64]           `json:"quotaSizeInBytes,omitempty"`
	ShouldChangePassword *bool                              `json:"shouldChangePassword,omitempty"`
	StorageLabel         nullable.Nullable[string]          `json:"storageLabel,omitempty"`
}
...
type UserAdminResponseDto struct {
	...
	Id                   string                         `json:"id"`
	IsAdmin              bool                           `json:"isAdmin"`
	License              nullable.Nullable[UserLicense] `json:"license"`
	Name                 string                         `json:"name"`
	OauthId              string                         `json:"oauthId"`
	ProfileChangedAt     time.Time                      `json:"profileChangedAt"`
	ProfileImagePath     string                         `json:"profileImagePath"`
	QuotaSizeInBytes     nullable.Nullable[int64]       `json:"quotaSizeInBytes"`
	QuotaUsageInBytes    nullable.Nullable[int64]       `json:"quotaUsageInBytes"`
	ShouldChangePassword bool                           `json:"shouldChangePassword"`
	Status               UserStatus                     `json:"status"`
	StorageLabel         nullable.Nullable[string]      `json:"storageLabel"`
	UpdatedAt            time.Time                      `json:"updatedAt"`
}
...
type UserAdminUpdateDto struct {
	...
	Name                 *string                            `json:"name,omitempty"`
	Password             *string                            `json:"password,omitempty"`
	PinCode              nullable.Nullable[string]          `json:"pinCode,omitempty"`
	QuotaSizeInBytes     nullable.Nullable[int64]           `json:"quotaSizeInBytes,omitempty"`
	ShouldChangePassword *bool                              `json:"shouldChangePassword,omitempty"`
	StorageLabel         nullable.Nullable[string]          `json:"storageLabel,omitempty"`
}
...
type VersionCheckStateResponseDto struct {
	CheckedAt      nullable.Nullable[string] `json:"checkedAt"`
	ReleaseVersion nullable.Nullable[string] `json:"releaseVersion"`
}
